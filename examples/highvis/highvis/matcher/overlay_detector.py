...
from highvis.tracker import BYTETracker, STrack, Detections
...
"""
 The OverlapDetector class extends the Detections class and is used to identify overlapping objects.
...
"""
 Constructs an arteficial bbox with provided size from the given centerpoints.
"""
...
"""
 Return the center points in the provided bboxes.
"""
