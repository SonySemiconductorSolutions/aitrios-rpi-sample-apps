...
from parking_monitor.tracker import STrack
from parking_monitor.tracker.tracker.bbox_overlaps import bbox_overlaps
...
class BYTETrackerArgs:
    ...
    def __str__(self):
        ret = f"""track_thresh {self.track_thresh},
...
def match_detections_with_tracks(detections, tracks: List[STrack]) -> np.array:
